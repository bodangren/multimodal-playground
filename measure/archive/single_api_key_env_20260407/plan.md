...
- [x] Task: Measure - User Manual Verification 'Phase 1: Environment Contract' (Protocol in workflow.md)
...
- [x] Task: Measure - User Manual Verification 'Phase 2: Docs and Verification' (Protocol in workflow.md)
