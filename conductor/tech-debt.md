...
| 2026-04-12 | single_api_key_env_20260407 | `app/page.test.tsx` fails due to pre-existing mock setup issue | Low | Open | Missing fetch mocks for some API calls cause `Cannot read properties of undefined (reading 'ok')`; documented in lessons-learned.md |
